...
const packs = {
  en: {
    ...
    text: {
      ...
      "collection.communityHint": "Select a registry match, or use + for a one-off name.",
      "collection.manualCommunityTitle": "Enter community name",
      "collection.manualCommunityLabel": "Community name",
      "collection.manualCommunityHint": "This records the name on this collection. It does not add a registry entry.",
      "collection.useCommunityName": "Use name",
  ...
  sw: {
    ...
    text: {
      ...
      "collection.communityHint": "Chagua kikundi kilichosajiliwa, au tumia + kuweka jina la muda.",
      "collection.manualCommunityTitle": "Weka jina la kikundi",
      "collection.manualCommunityLabel": "Jina la kikundi",
      "collection.manualCommunityHint": "Jina hili litawekwa kwenye rekodi hii tu. Haliongezwi kwenye usajili.",
      "collection.useCommunityName": "Tumia jina",
