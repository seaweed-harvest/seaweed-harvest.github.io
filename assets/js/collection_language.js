...
const packs = {
  en: {
    ...
    text: {
      ...
      "offline.backup": "Download backup",
      ...
      "offline.backupEmpty": "There are no unsynced records to back up.",
      "offline.restoreSaved": "Restored {count} pending record(s).",
  ...
  sw: {
    ...
    text: {
      ...
      "offline.backup": "Pakua nakala",
      "offline.restore": "Rudisha nakala",
      ...
      "offline.backupEmpty": "Hakuna rekodi ambazo hazijatumwa.",
      "offline.restoreSaved": "Rekodi {count} zimerudishwa.",
